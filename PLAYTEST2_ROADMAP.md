...
- **NEXT (fresh context):** (1) build93 = apply B92_SPECS items #2-#6 (read the particle/buildNotes code carefully) + store-hero JS items #9 Bonus-Sparks pricebox nudge / #10 buy-equip celebration; (2) **Phase 4** (task #163, CAREFUL — shadow-chart CPU rival at multiplayer.js:2869 + GH strict-strum, per PHASE4_DESIGN_PLAN.md §A keyboard-safety contract); (3) **Phase 6** (task #165, XL); (4) keep cycling critique/evolution rounds. (Cumulative playtest-readiness swarm over builds 88-92 in flight.)
