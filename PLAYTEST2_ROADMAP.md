...
- NEXT (fresh context): QA round #2 + design-evolution over Phases 1-3 (in flight) → implement Phase 5 (low-risk UI) → Phase 4 (careful gameplay) → Phase 6 (XL) → more critique/evolution rounds.
