...
- **NEXT (fresh context):** (1) build95 = apply B94_SPECS #2-#4 (kb-coachmark + search-film-cue + best-pass-juice) — review the loop-keeper's findings first; (2) build96 = B92_SPECS render-FX (#2 Perfect snap ring [careful particle edits], #3 approach band, #5 first-note beacon) + store-hero JS (#9 Bonus pricebox / #10 buy-equip celebration); (3) **Phase 4** (task #163, shadow-chart CPU rival at multiplayer.js:2869 + GH strict-strum, per PHASE4_DESIGN_PLAN.md §A); (4) **Phase 6** (task #165, XL); (5) keep cycling critique rounds.
